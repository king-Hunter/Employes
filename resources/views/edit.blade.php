...
@section('content')
    <div class="container">
        <!--{ { $item['today']->dato } }-->
        <form method="POST" action="{{ route('postEditE' , $item->id ) }}" role="form">
            {{ csrf_field() }}
            <div class="row justify-content-start">
                <div class="col-xs-6 col-sm-6 col-md-6">
                    <div class="form-group">
                        <label>Name </label>
                        <input type="text" pattern="[A-Z, a-z, ]*" name="name" id="name" class="form-control input-sm" value="{{ $item->name }}"
                            required>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col-xs-6 col-sm-6 col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="number" name="salary" id="salary" class="form-control input-sm" placeholder="{{ $item->salary_pesos }}">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row justify-content-start">
                ...
                <div class="col-xs-4 col-sm-4 col-md-4">
                    <div class="form-group">
                        <label>City </label>
                        <input type="text" name="city" id="city" class="form-control input-sm" value="{{ $item->state }}"
                            required>
                    </div>
                </div>
            </div>
            <div class="row justify-content-start">
                <div class="col-xs-5 col-sm-5 col-md-5">
                    <div class="form-group">
                        <label>Phone </label>
                        <input type="tel" name="phone" id="phone" class="form-control input-sm" value="{{ $item->phone }}"
                            required>
                    </div>
                </div>
            </div>
